...
const TechSkills: React.FC<TechSkillsProps> = ({ handleOpenTechSkills }) => {
  return (
    <div className="fixed inset-0 backdrop-blur-sm overflow-scroll">
      <div className="relative min-h-screen flex flex-col items-center md:justify-start md:pt-24 justify-center bg-zinc-200 mt-8 mx-4 px-4 py-8 border-2 border-zinc-800 rounded-lg">
        <h1 className="text-3xl md:text-4xl text-indigo-800 font-semibold">
          Technical Skills
        </h1>
        <p
          onClick={handleOpenTechSkills}
          className="text-2xl md:text-3xl font-bold text-red-500 fixed top-2 md:top-10 md:right-5 lg:top-20 lg:right-10 right-2"
        >
          X
        </p>
        <div className="text-black w-full px-4 md:w-screen md:pl-52 lg:pl-[21rem] pt-5 md:pt-12">
        ...
        <div className="text-black w-full px-4 md:w-screen md:pl-52 lg:pl-[21rem] pt-5 md:pt-10">
