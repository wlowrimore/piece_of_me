...
const Testimonials: React.FC<TestimonialsProps> = ({
  ...
  return (
    <div className="fixed inset-0 backdrop-blur-sm">
      <div className="relative flex flex-col items-center justify-center bg-zinc-200 mt-8 2xl:mt-14 mx-4 px-4 py-80 pb-16 border-2 border-zinc-800 rounded-lg overflow-scroll h-screen">
